...
function App() {
  ...
  const checkConfiguration = async () => {
    try {
      ...
      // Backend now handles API keys via Heroku config vars
      // No need for frontend configuration
      setIsConfigured(response.data.initialized)

      console.log('✅ Backend initialized:', response.data.initialized)
    } catch (error) {
      console.error('Failed to check configuration:', error)
      // Still set as configured - backend will handle API keys
